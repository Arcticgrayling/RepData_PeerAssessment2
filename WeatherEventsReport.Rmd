...
Here is a graph of the top Economic Cost events.
```{r}
...
Here is a graph of the top Casualty causing weather events
```{r}
d2 <- subset(data, data$Casualties > 0)
...
Session information for system used to create this report:
```{r}
sessionInfo()
```